...
# ---------------------------------------------------------------- سرفصل ۳۰ درس
SYLLABUS = [
    (1,  "He is a manager.",       "ضمائر فاعلی و افعال to be",        "سلام و احوالپرسی، معرفی خود"),
    (2,  "It's an umbrella.",      "a / an و اسم‌های جمع",              "اشیای اطراف ما"),
    (3,  "Who is he?",             "سوالی کردن با to be، who/what",     "پرسیدن درباره افراد"),
    (4,  "This is my sister.",     "صفات ملکی و 's مالکیت",             "خانواده"),
    (5,  "How old are you?",       "اعداد و پرسش سن",                   "اعداد، سن، تولد"),
    (6,  "Where are you from?",    "پرسش با where، حروف اضافه مکان",    "کشورها و ملیت‌ها"),
    (7,  "She is a nurse.",        "مشاغل با a/an",                     "شغل و محل کار"),
    (8,  "I go to school.",        "حال ساده: I/you/we/they",           "کارهای روزمره"),
    (9,  "He works every day.",    "حال ساده: he/she/it و s سوم‌شخص",   "روتین روزانه"),
    (10, "What time is it?",       "حروف اضافه زمان: at/on/in",         "ساعت و روزهای هفته"),
    (11, "I like music.",          "like/love/hate + ing",              "علاقه‌مندی‌ها"),
    (12, "Some rice, please.",     "اسم شمارا و ناشمارا، some/any",     "غذا و نوشیدنی"),
    (13, "I'd like a coffee.",     "would like / can I have",           "در رستوران"),
    (14, "There is a kitchen.",    "there is / there are",              "خانه و اتاق‌ها"),
    (15, "The cat is under the table.", "حروف اضافه مکان",              "وسایل خانه"),
    (16, "I have got a red coat.", "have got",                          "لباس و رنگ‌ها"),
    (17, "How much is it?",        "how much / this-these",             "خرید"),
    (18, "It's cold today.",       "it's + صفت، آب‌وهوا",               "آب‌وهوا و فصل‌ها"),
    (19, "I can swim.",            "can / can't",                       "توانایی‌ها"),
    (20, "I have a headache.",     "have got برای بیماری، should",      "بدن و سلامتی"),
    (21, "Turn left, please.",     "جملات امری",                        "حمل‌ونقل و مسیریابی"),
    (22, "She is reading now.",    "حال استمراری",                      "کارهای در حال انجام"),
    (23, "I usually walk.",        "حال ساده در برابر استمراری",        "مقایسه دو زمان"),
    (24, "I was at home.",         "گذشته to be: was/were",             "دیروز کجا بودی"),
    (25, "We played football.",    "گذشته ساده: افعال باقاعده",         "دیروز چه کردی"),
    (26, "I went to Tehran.",      "گذشته ساده: افعال بی‌قاعده",        "سفر گذشته"),
    (27, "Did you like it?",       "سوالی گذشته با did",                "تعطیلات و سفر"),
    (28, "I'm going to study.",    "be going to برای آینده",            "برنامه‌های آینده"),
    (29, "Tehran is bigger.",      "صفات تفضیلی",                       "مقایسه کردن"),
    (30, "The best day.",          "صفات عالی و مرور کلی",              "مرور سطح A1"),
]
...
# --- نقشه دروس
ws = sheet(wb, "نقشه دروس", ["درس","عنوان انگلیسی","موضوع گرامر","موضوع محتوایی","تعداد واژه","رایگان؟","وضعیت"],
           [8, 26, 34, 28, 12, 10, 12])
