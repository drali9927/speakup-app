    ...
    val (title, body) = when (status) {
        SpeechService.Status.MissingLanguage ->
            "صدای انگلیسی نصب نیست" to
                ...
                "در تنظیمات گوشی به بخش «تبدیل متن به گفتار» برو و زبان انگلیسی را نصب کن."
        SpeechService.Status.NoEngine ->
            "موتور صوت در دسترس نیست" to
                "روی این گوشی موتور تبدیل متن به گفتار پیدا نشد.\n\n" +
                "می‌توانی «Google Text-to-Speech» را از فروشگاه نصب کنی."
        else ->
            "در حال آماده‌سازی صدا" to "چند لحظه صبر کن و دوباره امتحان کن."
    }
