        ...
        Column(Modifier.padding(16.dp)) {
            ...
            if (enabled) {
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    //
                    // ۸ بعداً اضافه شد: آنبوردینگ چهار گزینه می‌دهد (صبح،
                    // ظهر، عصر، شب) و اینجا فقط سه‌تا بود. کسی که «صبح» را
                    // انتخاب کرده بود، اینجا هیچ گزینه‌ای روشن نمی‌دید و
                    // راهی هم به ۸ برنمی‌گشت — خلافِ قولی که همان‌جا داده‌ایم:
                    // «همه این‌ها را بعداً از پروفایل می‌توانی عوض کنی».
                    listOf(8, 12, 17, 20).forEach { h ->
                        val on = hour == h
                        Surface(
